...
import main.App;
import controllers.Transaction_Controller;
...
public class Transfer_Controller implements Initializable {
    ...
    public void transfer() {
        ...
        if (currentClient.transfer(transferTo_Client, selectedAmount) > -1) {
            ...
            currentClient.AddTransaction("Transfered to " + transferTo_Client.getUsername(),selectedAmount*-1);
            transferTo_Client.AddTransaction("Recieved From " + currentClient.getUsername() , selectedAmount);
